...
def custos(M_pulv_max,area_tot,tempo_util,comb_cons,voo,n_abs,dias,area_dia,Produtividade):
...
#================# PREÇO POR DIA # =============================#
    ...
    custo_folha_dia_piloto = (salario_piloto*(1+encargos) + insalubridade)/(dias_uteis_ano/12)*3
    custo_folha_dia_auxilar = (salario_auxiliar*(1+encargos) + insalubridade)/(dias_uteis_ano/12)*(1-aux_spad)*3
